...
def main():
        ...
        #Checking for the win condition
            ...
            if checking_word == chosen_word or checking_word == list("nagra"):
                ...
                for char in range(5):
                    ...
                    #Guesses reaching 0 not working properly, had to add this in to break the loop
                    elif guesses <= 0:
                        break
                    else:
    ...
    if guesses == 0:
        ...
        #Checking if they want to play again (I did not read the rubric)
        if again.lower().strip() == "y":
            main()

#Calling the function for the program to actually start
main()
